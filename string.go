...
func String(raw string) func(string) string {
	size := len(raw)
	...
	return func(key string) string { // * , ext , ipv4, ipv6 , [1,3]
		...
		case "ipv4":
			return strutil.String(strutil.Ipv4(raw))
		case "ipv6":
			return strutil.String(strutil.Ipv6(raw))
		case "ip":
			return strutil.String(strutil.Ipv4(raw) || strutil.Ipv6(raw))
		}
